 <div class="box" style="width: 80px; height: 80px; background-color: blue;  margin-left: 90%">
 ...
 <div id="footer"> <!--footer start--->
 	<div class="container">
 		...
 		<p>
 			<strong>www.MJ ENTERPRISES.com</strong>
 			<br>MADURAI
 			<br>CHENNAI
 			<br>COIMBATORE
 			<br>TRICHY
 ...
 <div id="copyright">  <!--cpy right section start-->
 	<div class="container">
 			...
 			<div class="col-md-6">
 				<p class="pull-left">&copy; 2024 MJ ENTERPRISES
